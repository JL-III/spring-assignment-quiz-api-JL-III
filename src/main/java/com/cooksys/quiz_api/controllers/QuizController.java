...
public class QuizController {
	...
	@PatchMapping("/{id}/add")
	@ResponseStatus(HttpStatus.CREATED)
	public QuizResponseDto modifyQuestion(@PathVariable Long id, @RequestBody QuestionRequestDto questionRequestDto) {
		return quizService.modifyQuestion(id, questionRequestDto);
	}
